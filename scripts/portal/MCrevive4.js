...
function enter(pi) {
    ...
    if(pi.getPlayer().getMCPlayerComponent() != null &&
        pi.getPlayer().getMCPlayerComponent().getTeam() == MonsterCarnival.Team.RED) {
        pi.warp(pi.getPlayer().getMapId() - 1, "red_revive");    
    } else {
        pi.warp(pi.getPlayer().getMapId() - 1, "blue_revive");
    }
