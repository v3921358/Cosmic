function enter(pi) {
    if(pi.isQuestCompleted(2333) && pi.isQuestStarted(2331) && !pi.hasItem(4001318)){
        pi.getPlayer().message("Lost the Royal Seal like a retard? Worry not! Kevin's code here to save your stupid ass.");
        if(pi.canHold(4001318)){
            pi.gainItem(4001318, 1);
        }
        else{
            pi.getPlayer().message("Motherfucka, how do you plan to hold this Seal when your inventory is full?");
        }
    }
