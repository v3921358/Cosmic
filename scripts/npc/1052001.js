...
function action(mode, type, selection) {
    ...
    if (actionx["1stJob"]){
        ...
        else if (status == 3)
        {
            if(cm.getPlayer().getMentorId() > 0)
            {
                cm.sendNextPrev("Dig deep into the darkness. Harness the energy as an #bUltimate Explorer#k to reach even greater heights! Also make sure to re-log and check your #bF12#k key!");    
            }
            else
            {
