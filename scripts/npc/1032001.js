...
function action(mode, type, selection) {
    ...
    if (actionx["1stJob"]){
        ...
        else if (status == 4)
        {
            if(cm.getPlayer().getMentorId() > 0)
            {
                cm.sendNextPrev("Ignite your passion for knowledge. Harness the energy as an #bUltimate Explorer#k to reach even greater heights! Also make sure to re-log and check your #bF12#k key!");    
            }
            else
            {
