...
public final class PlayerLoggedinHandler extends AbstractMaplePacketHandler {
    private class LogInProcedure implements Runnable {
        SeekableLittleEndianAccessor slea;
        MapleClient c;

        public LogInProcedure(SeekableLittleEndianAccessor slea, MapleClient c) {
            this.slea = slea;
            this.c = c;
        } 
    ...
    public final void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
        TimerManager.getInstance().schedule(new LogInProcedure(slea, c), 0);
    }
}
