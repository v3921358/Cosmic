...
//        return ret;
    ...
    // Generate number between (-range, range)
    ...
    public MakerItemFactory.MakerItemCreateEntry getMakerItemEntry(int toCreate) {
        MakerItemFactory.MakerItemCreateEntry makerEntry;

        if ((makerEntry = makerItemCache.get(toCreate)) != null) {
            return new MakerItemFactory.MakerItemCreateEntry(makerEntry);
        } else {
            try {
                Connection con = DatabaseConnection.getConnection();
                ...
                ps.close();
                rs.close();
                makerEntry = new MakerItemFactory.MakerItemCreateEntry(cost, reqLevel, reqMakerLevel);
                ...
                ps.close();
                con.close();
                makerItemCache.put(toCreate, new MakerItemFactory.MakerItemCreateEntry(makerEntry));
