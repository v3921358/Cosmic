...
UPDATE dietstory.drop_data SET `questid` = 28248 WHERE `dropperid` = 130100 AND `itemid` = 4001358;
UPDATE dietstory.drop_data SET `questid` = 28248 WHERE `dropperid` = 130101 AND `itemid` = 4001359;